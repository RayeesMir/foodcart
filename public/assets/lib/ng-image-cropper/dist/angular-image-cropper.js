...
/***/ function(module, exports) {
	...
	function Cropper(options) {
	  ...
	  var defaults = {
	    ...
	    actionLabels: {
	      ...
	      // fit: '<i class="material-icons">center_focus_strong</i>',
	      crop: 'DONE'
	    }
	  };
	...
	Cropper.prototype.buildDOM = function() {
	  ...
	  _elements.controls.crop.className = 'crop-btn';
	...
	//get crop values
	Cropper.prototype.getDetails = function() {
	...
	Cropper.prototype.dragging = function(event) {
	  ...
	  this.data.top = (top > 0)?top*100:0;
	  this.data.left = (left > 0)?left*100:0;
	};
    ...
    //rotate by angle
	Cropper.prototype.rotateAngle = function(ang) {
